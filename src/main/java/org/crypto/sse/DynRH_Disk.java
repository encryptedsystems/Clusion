...
/////////////////////				Response Hiding with add and delete operations on Disk					///////////
...
public class DynRH_Disk {
	...
	public static ConcurrentMap setup() {
		...
		ConcurrentMap<?, ?> dictionaryUpdates = db.hashMap("test").createOrOpen();
	...
	public static List<byte[]> query(byte[][] token, ConcurrentMap<String, byte[]> dictionaryUpdates)
			throws InvalidKeyException, InvalidAlgorithmParameterException, NoSuchAlgorithmException,
			NoSuchProviderException, NoSuchPaddingException, IOException {
	...
	public static void delete(byte[] deltoken, List<Integer> indices, ConcurrentMap<String, byte[]> dictionaryUpdates)
	...
	public static void deleteFS(byte[][] keys, ConcurrentMap<String, byte[]> dictionaryUpdates)
			throws UnsupportedEncodingException {
