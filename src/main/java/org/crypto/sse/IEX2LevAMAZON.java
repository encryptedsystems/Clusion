...
public class IEX2LevAMAZON {
	 ...
	 */
	 ...
	 /*
	  * Create a Multi-map that maps filenames and documents contents
	  * Stored in the form of a file
	  */
	 ...
	 /*
	  * Create a Multi-map that maps keywords to their filenames
	  * Stored in the form of a file
	  */
	 ...
	 public static class LocalMM extends Mapper<LongWritable, Text, Text, Text> {
		 ...
		 public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			 ...
			 for (String idDoc : lookup.get(token[0])){
				 ...
				 System.out.println("Document est: "+idDoc);
